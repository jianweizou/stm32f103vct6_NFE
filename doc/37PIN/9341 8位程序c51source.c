...
sbit  T_CS      = P3^0;  //touch sreen select  1.5
//sbit  T_BUSY    = P3^7;  //touch sreen busy   1.0
sbit  T_DCLK    = P3^6;  //SPI CLOCK   1.4
...
sbit  T_CS      = P2^0;  //touch sreen select  1.5
//sbit  T_BUSY    = P3^7;  //touch sreen busy   1.0
...
void LCD_WRITE_CMD(char CMD2);
void LCD_WRITE_CMD_DAT(char datacom);
...
/*
void touch_panel_tuning(U16 coord1, U16 adc1,
                        U16 coord2, U16 adc2,
                        float *slope,     float *offset)
{
   *slope=(float)((coord2-coord1)/(adc2-adc1));
   *offset=(float)coord1-(*slope)*(float)adc1;
}
*/
...
//		y= 0.0896 * (y - 287);//0.896
		...
		//	{
				...
				if(y<SCREEN_Y_START)
					...
					y=SCREEN_Y_END;
				LCD_Color_with_ADD(0x07,0xE0,240-x,240-x+1,320-y,320-y+1);
		//	}
		TP_CS(1);
	}
}
...
//     unsigned char hor,ver;
	 LCD_WRITE_CMD(0x2a);
	 LCD_WRITE_CMD_DAT ((x1&0xff00)>>8);
	 LCD_WRITE_CMD_DAT (x1&0x00ff);
	 LCD_WRITE_CMD_DAT ((x2&0xff00)>>8);
	 LCD_WRITE_CMD_DAT (x2&0x00ff);

	 LCD_WRITE_CMD(0x2b);
	 LCD_WRITE_CMD_DAT ((y1&0xff00)>>8);
	 LCD_WRITE_CMD_DAT (y1&0x00ff);
	 LCD_WRITE_CMD_DAT ((y2&0xff00)>>8);
	 LCD_WRITE_CMD_DAT (y2&0x00ff);
     LCD_WRITE_CMD(0x2c);
	for(i=0;i<y2-y1+1;i++)
            for (j=0;j<x2-x1+1;j++)
			{
...
LCD_WRITE_CMD_DAT (81); //c1
LCD_WRITE_CMD_DAT (0X30); 
 
LCD_WRITE_CMD(0xED);   
LCD_WRITE_CMD_DAT (0x64); 
LCD_WRITE_CMD_DAT (0x03); 
LCD_WRITE_CMD_DAT (0X12); 
LCD_WRITE_CMD_DAT (0X81); 
 
LCD_WRITE_CMD(0xE8);   
LCD_WRITE_CMD_DAT (0x85); 
LCD_WRITE_CMD_DAT (0x10); 
LCD_WRITE_CMD_DAT (0x78);  //7a
 
LCD_WRITE_CMD(0xCB);   
LCD_WRITE_CMD_DAT (0x39); 
LCD_WRITE_CMD_DAT (0x2C); 
LCD_WRITE_CMD_DAT (0x00); 
LCD_WRITE_CMD_DAT (0x34); 
...
LCD_WRITE_CMD_DAT (0x35);      //VRH[5:0]  //21
 
LCD_WRITE_CMD(0xC1);        //Power control 
LCD_WRITE_CMD_DAT (0x11);      //SAP[2:0];BT[3:0]  
 
LCD_WRITE_CMD(0xC5);        //VCM control 
LCD_WRITE_CMD_DAT (0x45); 		//3f
LCD_WRITE_CMD_DAT (0x45); 		//3c
 
LCD_WRITE_CMD(0xC7);        //VCM control2 
LCD_WRITE_CMD_DAT (0xa2); 	 //a7
 
LCD_WRITE_CMD(0x36);        // Memory Access Control 
LCD_WRITE_CMD_DAT (0x08); 	 //48
...
LCD_WRITE_CMD_DAT (0x0A); 
LCD_WRITE_CMD_DAT (0xA2); 
...
LCD_WRITE_CMD_DAT (0x26); //23
LCD_WRITE_CMD_DAT (0x1F); 
LCD_WRITE_CMD_DAT (0x0B); 
LCD_WRITE_CMD_DAT (0x0E); 
LCD_WRITE_CMD_DAT (0x08); 
LCD_WRITE_CMD_DAT (0x4B); 
LCD_WRITE_CMD_DAT (0XA8); 
LCD_WRITE_CMD_DAT (0x3B); 
LCD_WRITE_CMD_DAT (0x0A); 
LCD_WRITE_CMD_DAT (0x14); 
...
LCD_WRITE_CMD_DAT (0x08); 
LCD_WRITE_CMD_DAT (0x34); 
LCD_WRITE_CMD_DAT (0x47); 
LCD_WRITE_CMD_DAT (0x44); 
LCD_WRITE_CMD_DAT (0x05); 
LCD_WRITE_CMD_DAT (0x0B); 
LCD_WRITE_CMD_DAT (0x09); 
LCD_WRITE_CMD_DAT (0x2F); 
...
LCD_WRITE_CMD(0xC0); //Power control
LCD_WRITE_CMD_DAT(0x23); //VRH[5:0]

LCD_WRITE_CMD(0xC1); //Power control
LCD_WRITE_CMD_DAT(0x12); //SAP[2:0];BT[3:0]

LCD_WRITE_CMD(0xC2);
LCD_WRITE_CMD_DAT(0x11);

LCD_WRITE_CMD(0xC5); //VCM control
LCD_WRITE_CMD_DAT(0x40);
LCD_WRITE_CMD_DAT(0x30);

LCD_WRITE_CMD(0xc7);// 调水波纹
LCD_WRITE_CMD_DAT(0xb6);
...
LCD_WRITE_CMD(0xE0); //Set Gamma
LCD_WRITE_CMD_DAT(0x1f);
LCD_WRITE_CMD_DAT(0x24);
LCD_WRITE_CMD_DAT(0x23);
LCD_WRITE_CMD_DAT(0x0b);
LCD_WRITE_CMD_DAT(0x0f);
LCD_WRITE_CMD_DAT(0x08);
LCD_WRITE_CMD_DAT(0x50);
LCD_WRITE_CMD_DAT(0xd8);
LCD_WRITE_CMD_DAT(0x3b);
LCD_WRITE_CMD_DAT(0x08);
LCD_WRITE_CMD_DAT(0x0a);
LCD_WRITE_CMD_DAT(0x00);
...
LCD_WRITE_CMD_DAT(0x2f);
LCD_WRITE_CMD_DAT(0x27);
LCD_WRITE_CMD_DAT(0x44);
LCD_WRITE_CMD_DAT(0x07);
LCD_WRITE_CMD_DAT(0x15);
LCD_WRITE_CMD_DAT(0x0f);
LCD_WRITE_CMD_DAT(0x3f);
LCD_WRITE_CMD_DAT(0x3f);
LCD_WRITE_CMD_DAT(0x1F);
...
void adderset(int xs,int xe,int ys,int ye){
	 ...
	 LCD_WRITE_CMD(0x2a);
	 LCD_WRITE_CMD_DAT ((xs&0xff00)>>8);
	 LCD_WRITE_CMD_DAT (xs&0x00ff);
	 LCD_WRITE_CMD_DAT ((xe&0xff00)>>8);
	 LCD_WRITE_CMD_DAT (xe&0x00ff);

	 LCD_WRITE_CMD(0x2b);
	 LCD_WRITE_CMD_DAT ((ys&0xff00)>>8);
	 LCD_WRITE_CMD_DAT (ys&0x00ff);
	 LCD_WRITE_CMD_DAT ((ye&0xff00)>>8);
	 LCD_WRITE_CMD_DAT (ye&0x00ff);
     LCD_WRITE_CMD(0x2c);
}
